...
class Node:
    ...
    def drawline(self, sc:pygame.Surface, node) -> None:
        '''
        '''
        pygame.draw.line(sc, yellow, (self.x, self.y), (node.x, node.y))
        
    def draw_on_screen(self, color, sc:pygame.Surface) -> None:
